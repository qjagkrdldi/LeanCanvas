...
function CanvasCard({ title, isubtitle = false }) {
  ...
  return (
    <div className="row-span-1 bg-white min-h-48 border border-collapse border-gray-300">
      <div
        className={`${isubtitle === false && "bg-gray-100 border-b border-b-gray-300"} flex justify-between px-3 py-2`}
      >
        <h3 className={`${isubtitle === false && "font-bold"}`}>{title}</h3>
        <button
